...
const FAQ: { question: string; answer: string }[] = [
  {
    ...
    answer:
      'Συμμετοχή σε όλα τα forums, προσωπικά μηνύματα, συμμετοχή στα events που διοργανώνει το KousKous και πρόσβαση στους διαγωνισμούς και τα δώρα του Rewards Club.',
  },
  {
