...
const FAQ: { question: string; answer: string }[] = [
  {
    ...
    answer:
      'Συμμετοχή σε όλα τα forums, προσωπικά μηνύματα, δήλωση συμμετοχής σε events και πρόσβαση στο Rewards Club. Ο δωρεάν λογαριασμός βλέπει το feed και τα events, αλλά δεν συμμετέχει.',
  },
  {
